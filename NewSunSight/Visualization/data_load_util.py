...
def get_clean_zips():
    os.chdir('/Users/thewelcomer/Coding/Solstice/SunSight/Visualization')
...
def Make_dataset(remove_outliers=True):
    ...
    combined_df['carbon_offset_metric_tons_per_panel'] = (combined_df['carbon_offset_metric_tons'] / 
                                                         (combined_df['number_of_panels_total'] - combined_df['existing_installs_count']))
    ...
    # Ensure GWR column is kept if it exists
    if 'GWR' in combined_df.columns:
        # If any preprocessing of GWR values is needed, do it here
        pass
